...
| [topj.queryNodeInfo()](#获取节点信息)                     | 获取节点信息。                    |
...
| publicKey          |                      | String | 公钥。                                                       |
| token              | identity_token       | String | 身份令牌,用于和主链节点交互，每次请求都需要该参数。需要调用“topj.passport"接口获取，只需获取一次。 |
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println(JSON.toJSONString(chainInfo));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            topj.requestToken(account);
            ResponseBase<AccountInfoResponse>  accountInfoResponse = topj.getAccount(account);
            ResponseBase<XTransaction> responseBase = topj.transfer(account,"T-0-LiC6tHMcmS8Qpn6LQuWcLRXjvGuYXQGthd", BigInteger.valueOf(140), "");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            topj.requestToken(account);
            ResponseBase<AccountInfoResponse>  accountInfoResponse = topj.getAccount(account);
            ResponseBase<XTransaction> responseBase = topj.getTransaction(account, "0x93f906ca10e244af90e987682823d16dc710bc909122397fb1c4364ab85cdb55");
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            HttpService httpService = new HttpService("http://192.168.50.26:19081");
            topj = Topj.build(httpService);
            topj.setTransactionReceiptProcessor(new PollingTransactionReceiptProcessor(topj, 5000, 3));
            account = topj.genAccount("ff867b2ceb48f6bfc8a93d6c6aac05a29baad5da18ab5fb2bb9758379475fad8");
            topj.requestToken(account);
            ResponseBase<AccountInfoResponse>  accountInfoResponse = topj.getAccount(account);
            ResponseBase<XTransaction> result = topj.stakeGas(account, BigInteger.valueOf(4000));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            topj.requestToken(account);
            ResponseBase<AccountInfoResponse>  accountInfoResponse = topj.getAccount(account);
            ResponseBase<XTransaction> result = topj.unStakeGas(account, BigInteger.valueOf(4000));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
### 部署用户智能合约
部署用户合约，部署合约前，发起人的账户余额应该大于100,000uTOP token，这100,000uTOP token将用作交易保证金。
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            ResponseBase<XTransaction> result = topj.deployContract(account, codeStr, BigInteger.valueOf(200));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
调用用户合约，调用合约前，发起人的账户余额应该大于100,000uTOP token，这100,000uTOP token将用作交易保证金。
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            topj.requestToken(account);
            ResponseBase<AccountInfoResponse>  accountInfoResponse = topj.getAccount(account);
            String accountAddress = "T-3-MXrp9MAxk3WKe4Bn5obqmnUBhCyCavXRiR";
            ResponseBase<XTransaction> result = topj.callContract(account, accountAddress, "opt_map", Arrays.asList("testKey", "testValue"));
            ResponseBase<GetPropertyResponse> pResult = topj.getListProperty(account, accountAddress, "mlist");
            System.out.println(JSON.toJSONString(pResult));
            pResult = topj.getMapProperty(account, accountAddress, "hmap", "testKey");
            System.out.println(JSON.toJSONString(pResult));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            ResponseBase<GetPropertyResponse> pResult = topj.getListProperty(account, accountAddress, "mlist");
            pResult = topj.getMapProperty(account, accountAddress, "hmap", "testKey");
            pResult = topj.getStringProperty(account, accountAddress, "temp_1");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            topj.requestToken(account);
            ResponseBase<AccountInfoResponse>  accountInfoResponse = topj.getAccount(account);
            ResponseBase<XTransaction> result = topj.registerNode(account, BigInteger.valueOf(1000000), NodeType.advanced);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            topj.requestToken(account);
            ResponseBase<AccountInfoResponse>  accountInfoResponse = topj.getAccount(account);
            ResponseBase<XTransaction> result = topj.unRegisterNode(account);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            topj.requestToken(account);
            ResponseBase<AccountInfoResponse>  accountInfoResponse = topj.getAccount(account);
            ResponseBase<XTransaction> result = topj.redeemNodeDeposit(account);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
兑票时要输入锁定期，不同的锁定期兑票比例不一样，锁定期越长，相同票数锁定越少的TOP token。
...
| lockTime | 是       | -      | String  | TOP token锁定期，锁定期单位：天。<br/>兑票规则：<br/>votes_amount / [ 1.04^(lock_duration / 30 - 1) ], duration < 570；<br/>vote_amount / 2,                        lock_duration >= 570。<br/>锁定期最少为30天，且必须为30的整数倍。锁定期越长，相同的兑票数量锁定越少的TOP token。 |
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            topj.requestToken(account);
            ResponseBase<AccountInfoResponse>  accountInfoResponse = topj.getAccount(account);
            ResponseBase<XTransaction> redeemTokenVote = topj.unStakeVote(account, new BigInteger("1000"), "");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            String nodeAddress = "T-0-LRaFyaGZ1isfcKnhLxPLoePFUmY2iyFGv6";
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            topj.requestToken(account);
            ResponseBase<AccountInfoResponse>  accountInfoResponse = topj.getAccount(account);
            ResponseBase<VoterDividendResponse> result1 = topj.queryVoterDividend(account, account.getAddress());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            topj.requestToken(account);
            ResponseBase<AccountInfoResponse>  accountInfoResponse = topj.getAccount(account);
            ResponseBase<XTransaction> result = topj.claimVoterDividend(account);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            topj.requestToken(account);
            ResponseBase<AccountInfoResponse>  accountInfoResponse = topj.getAccount(account);
            ResponseBase<XTransaction> result = topj.claimNodeReward(account);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
> * 普通账户地址也可以给此链上治理账户转账。
> * 链上治理账户地址为：T-21-38QMHWxXshXyZa1E48JU1LREu3UrT5KGD2U@0
...
| target                 | 是       | -      | String | 当提案类型为修改链上治理参数提案时，target为链上治理参数名称，链上治理参数请参见[链上治理参数说明](docs-cn/On-ChainGovernance/On-ChainGovernance parameters.md)；<br/>当提案类型为社区基金管理提案时，target为接受转账账户地址，销毁账户地址为：T-!-Ebj8hBvoLdvcEEUwNZ423zM3Kh9d4nL1Ug。 |
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            ResponseBase<XTransaction> addProposalResult = topj.submitProposal(account, proposal);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            Proposal proposal = new Proposal();
            proposal.setProposalId("sss");
            ResponseBase<XTransaction> addProposalResult = topj.withdrawProposal(account, proposal.getProposalId());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            topj.requestToken(account);
            ResponseBase<AccountInfoResponse> accountInfoResponse = topj.getAccount(account);
            ResponseBase<Proposal> propertyResult = topj.queryProposal(account, "sss");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            ResponseBase<XTransaction> addProposalResult = topj.tccVote(account, proposal.getProposalId(), clientAddress3, true);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
public class main {
    ...
    public static void main(String[] args){
        HttpService httpService = new HttpService("http://localhost:19081");
        topj = Topj.build(httpService);
        account = new Account("ff867b2ceb48f6bfc8a93d6c6aac05a29baad5da18ab5fb2bb9758379475fad8");
...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            ResponseBase<AccountInfoResponse>  accountInfoResponse = topj.getAccount(account);
            ResponseBase<XTransaction> responseBase = topj.transfer(account,"T-0-LiC6tHMcmS8Qpn6LQuWcLRXjvGuYXQGthd", BigInteger.valueOf(140), "");
            System.out.println("transfer hash >> " + responseBase.getData().getTransactionHash() + " >> is success > " + responseBase.getData().isSuccess());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
|                    |                      |                     | action_name              | String | 调用合约时，合约的函数名。系统合约函数请参见[系统合约函数](docs-cn/Interface/SmartContractInterface/SystemContractFunction.md)。 |
