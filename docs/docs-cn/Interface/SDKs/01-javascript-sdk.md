...
| cluster_id              | Uint8  | 账户所在clsuter ID，cluster包括auditor group和validator group。 |
...
| nonce                   | Uint64 | 该账户最新共识成功的交易序号，唯一。                         |
| shard_id                | Uint8  | 即validator group ID。                                       |
...
| zone_id                 | Uint8  | zone ID，zone由共识cluster组成。                             |
...
| target                 | String | 当提案类型为修改链上治理参数提案时，target为链上治理参数名称，链上治理参数请参见[链上治理参数说明](docs-cn/On-ChainGovernance/On-ChainGovernance parameters.md)；<br/>当提案类型为社区基金管理提案时，target为接受转账账户地址，销毁账户地址为：T-b-gkhLhFJXVN3ZPQYZxphja93BEUtwKRdden。 |
