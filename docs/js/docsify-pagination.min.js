...
//			}
//		} else {
//			typeof t.getAttribute("href")
//			return decodeURIComponent(t.getAttribute("href").split("?")[0]) === decodeURIComponent(e)
//		}
	}
	var y = function() {
		function n(t) {
...
//			console.log('e======',e)
//			if (t.prev) {
//				str += '<div class="pagination-item pagination-item--previous">'
//					+     '<a href="' + t.prev.href + '">'
//					+        '<div class="pagination-item-label">'
//					+           '<span>' + e.previousText + '</span>'
//					+        '</div>'
//					+        '<div class="pagination-item-title">' + t.prev.name + '</div>';
//				if (e.crossChapterText) {
//					str += '<div class="pagination-item-subtitle">' + t.prev.chapterName + '</div>';
//				}
//				str += '</a></div>';
//			}
//			if (t.next) {
//				str += '<div class="pagination-item pagination-item--next">'
//				    +     '<a href="' + t.next.href + '">'
//				    +        '<div class="pagination-item-label">'
...
//				if (e.crossChapterText) {
//					str += '<div class="pagination-item-subtitle">' + t.next.chapterName + '</div>';
//				}
//				str += '</a></div>';
//			}
//			return str;
